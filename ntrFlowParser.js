...
const RANGE1 = "2025-07-16!A5:M50"; // 47주차
const RANGE2 = "2025-07-09!A5:M54"; // 47주차
const RANGE3 = "2025-07-02!A5:M54"; // 46주차
const RANGE4 = "2025-06-25!A5:M54"; // 45주차
const RANGE5 = "2025-06-18!A5:M54"; // 44주차
const RANGE6 = "2025-06-11!A5:M54"; // 43주차
const RANGE7 = "2025-06-04!A5:M54"; // 42주차
...
async function fetchSheetData() {
  ...
  // 각 주차별 데이터 가져오기
  const [data7, data6, data5, data4, data3, data2, data1] = await Promise.all([
    fetchSheetRange(sheets, RANGE7, "42주차"),
    fetchSheetRange(sheets, RANGE6, "43주차"),
    fetchSheetRange(sheets, RANGE5, "44주차"),
    fetchSheetRange(sheets, RANGE4, "45주차"),
    fetchSheetRange(sheets, RANGE3, "46주차"),
    fetchSheetRange(sheets, RANGE2, "47주차"),
    fetchSheetRange(sheets, RANGE1, "48주차"),
  ]);

  // 모든 데이터 합치기 (주차별로)
  const allData = [...data7, ...data6, ...data5, ...data4, ...data3, ...data2, ...data1];
